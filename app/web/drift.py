...
from app.view_models.drift import DriftCollections
...
def send_drift(gid):
    ...
    if current_gift.is_self_gift(current_user.id):
    ...
    if request.method == 'POST' and form.validate():
        ...
        email.send_mail(current_gift.user.email, '有人想要一本书',
...
def pending():
    ...
    views = DriftCollections(drifts, current_user.id)
